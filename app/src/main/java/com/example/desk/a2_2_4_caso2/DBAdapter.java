...
/**
 * Created by desk on 14/03/18.
 */

public class DBAdapter {
    //Tabla Paciente
    static final String ID_P = "_id";
    ...
    //Tabla Medicamentos
    static final String ID_M = "_id";
    static final String ID_P_M = "_idpaciente";
    ...
    public Cursor getAllPacientes() {
        return db.query(DATABASE_TABLE_P, new String[] {ID_P, NAME_P,
    ...
    public Cursor getAllPaciente(int rowId) throws SQLException {
        Cursor mCursor =
                db.query(true, DATABASE_TABLE_P, new String[] {ID_P,
                                NAME_P, ADDRESS_P,EMAIL_P,DATE_P}, ID_P + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
    ...
    public Cursor getAllMedicamentosAZ(int idp) {
        return db.query(true, DATABASE_TABLE_M,
                new String[] {ID_M,ID_P_M,NAME_M, DATE_INI_M},
                ID_P_M + "=" + idp, null,
    ...
    public Cursor getAllMedicamentosVigAZ(int idp) {
        return db.query(true, DATABASE_TABLE_M,
                new String[] {ID_M,ID_P_M,NAME_M, DATE_INI_M},
                ID_P_M + "=" + idp+" AND "+VIGENCIA_M+"=1", null,
                null, null,NAME_M, null);
    }
    ...
    public boolean updatePaciente(long rowId, String name, String address, String email,String dt) {
        ...
        return db.update(DATABASE_TABLE_P, initialValues, ID_P + "=" + rowId, null) > 0;
    }
    //Update medicamento
    public boolean updateMedicamento(long rowId,int idp,String nombre,String pade,String inst,String fcon,String fini,String ffin,int vig) {
        ...
        initialValues.put(DATE_FIN_M, ffin);
        initialValues.put(VIGENCIA_M, vig);
        return db.update(DATABASE_TABLE_M, initialValues, ID_M + "=" + rowId, null) > 0;
    }
